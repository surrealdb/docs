...
For example, if you had the text **"apple man"**, the `class` tokenizer would split by whitespace, which the `ngram` filter would further split into these tokens: **["a", "p", "p", "l", "e", "ap", "pp", "pl", "le", "app", "ppl", "ple", "m", "a", "n", "ma", "an", "man"]**. 
